...
import { X, CreditCard, MapPin, User as UserIcon, Phone, Mail, ShoppingBag, Plus, Minus } from 'lucide-react';
import { useApp } from '../context/AppContext';

export default function ProductOrderModal({ isOpen, onClose, product }) {
            ...
            {step === 3 && (
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h5 className="font-semibold mb-3">Final Order Summary</h5>
                ...
                <div className="flex space-x-3">
                  ...
                  <button
                    ...
                    className={`flex-1 py-3 rounded-lg font-semibold transition-colors ${
                      isProcessing || !state.isAuthenticated
                        ? 'bg-gray-400 text-white cursor-not-allowed'
                        : 'bg-primary-600 text-white hover:bg-primary-700'
                    }`}
                  >
                    {isProcessing ? 'Processing...' : !state.isAuthenticated ? 'Please Sign In' : 'Place Order'}
                  </button>
                </div>
              </div>
            )}
